...
#define CONTROL_BAND_2200   0x01 //Y0   BS0=1 BS1=0
#define CONTROL_BAND_630    0x02 //Y1   BS0=0 BS1=1
     // need to define BS2 for Transmit  TX BS2=1   RX  BS2=0 
#define CONTROL_BAND_TX 0x04 //Y2  BS2=1
