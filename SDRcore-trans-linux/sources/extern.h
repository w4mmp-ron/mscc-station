...
/* Index meaning "no mic selected yet" — must be outside [0, MAX_INPUT_DEVICES). */
...
extern int num_digital_input_devices_found;
...
extern int Get_Operator_Sound_Device(void);
