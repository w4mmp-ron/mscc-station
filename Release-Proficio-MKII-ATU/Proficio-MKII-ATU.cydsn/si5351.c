...
#define DEFAULT_CALIBRATION_INT 0
#define DEFAULT_CALIBRATION_DEC -60
...
volatile int8 E_calibration_int = DEFAULT_CALIBRATION_INT;//Set by USB interrupt routine
volatile int8 E_calibration_dec = DEFAULT_CALIBRATION_DEC;//Set by USB interrupt routine
