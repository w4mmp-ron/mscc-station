...
*
* \funcusage
*  \snippet USBFS_VBUS_SUT.c usage_USBFS_VBUS_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet USBFS_VBUS_SUT.c usage_USBFS_VBUS_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet USBFS_VBUS_SUT.c usage_USBFS_VBUS_Read  
*******************************************************************************/
...
* preferred USBFS_VBUS_Read() API because the 
* USBFS_VBUS_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet USBFS_VBUS_SUT.c usage_USBFS_VBUS_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: USBFS_VBUS_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use USBFS_VBUS_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - USBFS_VBUS_0_INTR       (First pin in the list)
    *  - USBFS_VBUS_1_INTR       (Second pin in the list)
    *  - ...
    *  - USBFS_VBUS_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet USBFS_VBUS_SUT.c usage_USBFS_VBUS_SetInterruptMode
    *******************************************************************************/
    void USBFS_VBUS_SetInterruptMode(uint16 position, uint16 mode) 
                            
    {
		if((position & USBFS_VBUS_0_INTR) != 0u) 
		{ 
			 USBFS_VBUS_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet USBFS_VBUS_SUT.c usage_USBFS_VBUS_ClearInterrupt
    *******************************************************************************/
