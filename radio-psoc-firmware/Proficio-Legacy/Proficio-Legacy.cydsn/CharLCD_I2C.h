...
#define DISPLAY_CMD_DELAY_US			 (2000u)/* 2.0 msec Delay */
#define DISPLAY_DATA_DELAY_US			 (500u)/*  0.50 msec Delay */
#define DISPLAY_NIB_DELAY_US			 (100u)/*  0.10 msec Delay */
#define DISPLAY_INIT_DELAY			  	 (20u) /*  20.0 msec Delay */
#define DISPLAY_INIT_UP_NIB_DELAY	  	 (5u) /*   5.0 msec Delay */
#define DISPLAY_INIT_CMD_DELAY		  	 (5u) /*   5.0 msec Delay */
