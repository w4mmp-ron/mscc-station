...
| B07 | — | — | NC |
| B08 | **USBV+** | **PA9** | Host USB 5 V sense; **divider → ≤ 3.3 V** at PA9 (not radio 5 V) |
| B09 | — | — | NC |
...
| Item | Status |
|------|--------|
| **USBV+** (B8) | **Locked → PA9** (divider); see `VBUS-SENSE-FOR-STEW.md` |
