...
Creator project is still `Proficio-MKII-ATU.cydsn` / `.cywrk` (rename deferred). Firmware major is **7**; USB product string in generated `USBFS_descr.c` is **Ultimus**. A Creator USB regenerate can restore “Proficio” until the USBFS component catalog string is edited.
