...
#define DieTemp_1_MAX_WAIT_USEC          (DieTemp_1_MAX_WAIT * 1000u)    /* In usec */
#define DieTemp_1_USEC_STEP              (10u) /* Step in usec */
...
/*******************************************************************************
* Function Name: DieTemp_1_GetTempT
********************************************************************************
*
* Summary:
*  Sends the command and parameters to the SPC to start a Die Temperature 
...
*  The Status code from DieTemp_1_Start or DieTemp_1_Query.
*
*******************************************************************************/
static cystatus DieTemp_1_GetTempT(int16 * temperature) 
{
    ...
    if(status == CYRET_STARTED)
    {
        ...
        * DieTemp_1_MAX_WAIT_USEC is maximum time in usec to wait for SPC.
        **************************************************************************/
        for (us=(DieTemp_1_MAX_WAIT_USEC); us>0u; us-=DieTemp_1_USEC_STEP)
        {
