...
*   securityKey - The 6 byte or null security key used to authenticate with 
*                 bootloader component. Please refer tobootloader datasheet for more 
*                 information about security key.
...
*   file        - The full canonical path to the *.cyacd file to open
*   securityKey - The 6 byte or null security key used to authenticate with 
*                 bootloader component. Please refer to bootloader datasheet for 
*                 more information about security key.
*   appId       - The application number to run when programming finishes. 1 for app1, 2 for app2, else noop
*   comm        - Communication struct used for communicating with the target device
*   update      - Optional function pointer to use to notify of progress updates
*
...
* Parameters:
*   file        – The full canonical path to the *.cyacd file to open
*   securityKey - The 6 byte or null security key for authentication with 
*                 bootloader component. Please refer to bootloader datasheet for 
*                 more information about security key.
*   comm        – Communication struct used for communicating with the target device
*   update      - Optional function pointer to use to notify of progress updates
